...
var RequestScheduler = module.exports = function(delay, connectionLimit) {
	...
	/**
	 * How many URLs are awating to be executed by the current
	 * scheduler
	 *
 ...
 * @method requestDone
 */
RequestScheduler.prototype.requestDone = function() {
	this._connections -= 1;
...
//		}
	...
	if (queueToExecute) {
		...
		item.resolver.resolve(item.url);
	}
