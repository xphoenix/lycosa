...
var Crawler = module.exports = function() {
	...
	this.defaults = {
		...
		// How many bytes we are ready to keep in memory
...
Crawler.prototype._execute = function(trace) {
	...
	var self = this;
	var promise = this._requests[trace.id] = this._prepare(trace).ensure(function(){
...
Crawler.prototype._fetch = function(trace) {
	...
	return this._behave('fetchPageContent', trace).then(function(fetchResult){
		...
		var cookies = (fetchResult ? fetchResult.headers['set-cookie'] : []) || [];
